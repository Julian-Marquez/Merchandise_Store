...
<html lang="en">
    <head>
        ...
        <title>Pod Talk - Confirmed Purchase</title>
    ...
    <body>
        <main>
                ...
                <div class="container">
                    <form action="#" method="get" class="custom-form search-form flex-fill me-3" role="search">
                        <div class="input-group input-group-lg">    
                            <input name="search" type="search" class="form-control" id="search" placeholder="Search Products" aria-label="Search">
            ...
            <section class="confirmation-section section-padding" id="confirmation_section">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12 col-12">
                            <div class="section-title-wrap mb-5">
                                <h4 class="section-title">Thank you for your purchase!</h4>
                            </div>
  ...
  <%@ page import="java.text.DecimalFormat" %>
        ...
        User loggedinuser = (User) context.getAttribute("loggedinUser");
 		...
 		try {
			...
			for(Items items : loggedinuser.getallitems()) {
				allitemamounts++;
				absoulutetotal = absoulutetotal + items.gettotalprice();
				
				context.setAttribute("crunchtotal", Double.toString(items.gettotalprice()));
	...
	<%	}
 		...
 		loggedinuser.getallitems().clear();
        %>   
                                
                                <!-- Total Price -->
                                <div class="total-price">
                                	Amount Of Items: ${allitemsamount}
                            ...
                            <div class="text-right mt-4">
                                <form action="Accounts" method="post">
                                    <button  name="Products" value="Products"> <span class="button">Continue Shopping</span></button>
                                </form>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 col-12 mb-4 mb-md-0 mb-lg-0">
                        ...
                        <p><strong class="d-inline me-2">Email:</strong>
